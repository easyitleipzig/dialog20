...
class Dialog {                    // dialog drag and resize
      constructor( param ) {
        this.opt = {
            ...
            dialogMenuClass:    "dialogMenu", // optional - add this class to dialog menu
            dialogContentClass: "dialogContent", // optional - add this class to dialog content
            dialogFooterClass:  "dialogFooter", // optional - add this class to dialog footer
            dialogBoxClass:     "dialogBox", // optional - add this class to dialog box
            dialogWrapperClass: "dialogWrapper", // optional - add this class to the dialog wrapper
            ...
            pathToHelpInfo:     "help/", // optional - the path to the help and info files; is "" or the path
            fileHelp:           "", // optional - true/false
            hasMin:             false,
            hasMax:             false,
            hasSticky:          false,
            hasClose:           true,
        ...
        let showOnInit = true,
            boxId = this.opt.id.substr( 1, this.opt.id.length - 1 ),
            tmpClasses = "";
        ...
        nj().lCS( this.opt.defaultCSSFile );
        let el = null;
        ...
        nj( el_add ).aCl( this.opt.classPraefix + "Menu " + this.opt.dialogMenuClass );
        ...
        nj( el_dia ).aCl( this.opt.dialogContentClass );
        ...
        nj( el_add ).aCl( this.opt.classPraefix + "Footer " + this.opt.dialogFooterClass );
        if( this.opt.buttons ) {
        ...
        nj( box ).aCl( "boxHide " + this.opt.classPraefix + "Box " + this.opt.dialogBoxClass );
        if( this.opt.modal ) {
            let el_wr = nj().cEl( "div" );
            el_wr.id = this.boxId + "_wrapper";
            nj( el_wr ).aCl( this.opt.dialogWrapperClass + " dialogWrapper" );
